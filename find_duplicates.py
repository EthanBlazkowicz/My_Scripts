...
def find_duplicates(directory, min_size=1024):
    ...
    print(
        f"Found {len(potential_duplicates)} groups of files with the exact same size. Verifying contents..."
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Quickly find duplicate files on network drives."
    )
